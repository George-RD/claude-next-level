...
- **Cross-references:** `[see-also:specs/from-tests/module.spec.md]` — link to related test spec (source mode only)
...
**See Also:** [see-also:specs/from-tests/module.spec.md] (source mode only, omit if no cross-ref)
